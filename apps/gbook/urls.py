...
urlpatterns = patterns('gbook.views',     
    ...
    url(ur'^section/(?P<section>\D.+)/$', 'gbook_view', name='gbook_view_section'),            
    ...
    url(r'^edit-theme/(?P<theme>[a-z,_,-,-,0-9]+)$', 'gbook_edit_theme', name='gbook_edit_theme'),
    ...
    url(ur'^view-profile/(?P<view_profile>\D.+)/$', 'gbook_view_profile', name='gbook_view_profile'),
    url(ur'^сhange-password/$','gbook_change_password', name='gbook_change_password'),     
     # private messages 
    url(ur'^send-message/to/(?P<message_to_profile>\D.+)/$', 'gbook_send_message', name='gbook_send_message'),     
    url(r'^my-private-messages/$', 'gbook_private_messages', name='gbook_private_messages'),
    url(ur'^show-chat/with/(?P<with_profile>\D.+)/$', 'gbook_show_chat', name='gbook_show_chat'),
     # karma
    url(r'^my-karma/$', 'gbook_my_karma', name='gbook_my_karma'),     
    url(ur'^(?P<karma_delta>[a-z,_,-,-,0-9]+)/to/(?P<to_profile>\D.+)/$', 'gbook_change_karma', name='gbook_change_karma'),                
     # registration
    ...
    url(ur'^admin/manage-profile/(?P<manage_profile>\D.+)$', 'gbook_admin_manage_profile', name='gbook_admin_manage_profile'), 
    url(ur'^admin/delete-profile/(?P<delete_profile>\D.+)$', 'gbook_admin_delete_profile', name='gbook_admin_delete_profile'), 
    url(ur'^admin/add-ban/(?P<to_profile>\D.+)$', 'gbook_admin_add_ban', name='gbook_admin_add_ban'), 
    url(ur'^admin/remove-ban/(?P<to_profile>\D.+)$', 'gbook_admin_remove_ban', name='gbook_admin_remove_ban'),   
