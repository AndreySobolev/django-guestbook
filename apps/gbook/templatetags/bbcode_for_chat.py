...
URL_RE = r'\s*(http:\/\/|)(www.|)((?:(?:[A-Z0-9](?:[A-Z0-9-]{0,61}[A-Z0-9])?\.)+[A-Z]{2,6}\.?|'\
...
BBCODE_RULES = [
        ...
        {'pattern': r'\[kruto\]', 'repl': r'<img src="'+ PATH_TO_SMILES + 'kruto.gif">'},
        ...
        {'pattern': r'\[gbi\]', 'repl': r'<img src="'+ PATH_TO_SMILES + 'gbo.gif">'},
